...
- (void)drawWithFrame:(NSRect)cellFrame inView:(NSView *)controlView
{
	...
	if (style == SRGradientBorderStyle) {
		...
		if (isRecording)
		{
			...
			[snapBackArrow drawAtPoint:[self _snapbackRectForFrame: cellFrame].origin
                              fromRect:NSZeroRect
		...
		if (!isRecording)
		{
			...
			if (![self _isEmpty] && [self isEnabled])
			{
                ...
                [removeImage drawAtPoint:[self _removeButtonRectForFrame: cellFrame].origin
                                  fromRect:NSZeroRect
                                 operation:NSCompositeSourceOver
                                  fraction:1.0f];
			}
        ...
        //	if (isVaguelyRecording)
		{
            ...
            [snapBackArrow drawAtPoint:correctedSnapBackOrigin
                              fromRect:NSZeroRect
                             operation:NSCompositeSourceOver
...
- (void)_createGradient
{
	NSColor *gradientStartColor = [NSColor colorWithCalibratedRed:0.176f green:0.549f blue:0.847f alpha:1.00f];
	NSColor *gradientEndColor = [NSColor colorWithCalibratedRed:0.116f green:0.372f blue:0.642f alpha:1.00f];
